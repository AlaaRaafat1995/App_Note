...
class EditSecretNote extends StatefulWidget {
  EditSecretNote({
    Key? key,
    this.title,
    this.note,
  ...
  @override
  State<EditSecretNote> createState() => _EditSecretNoteState();
}

class _EditSecretNoteState extends State<EditSecretNote> {
      ...
      appBar: AppBar(
        ...
        actions: [
          ...
          iconbutton(() async {
            ...
            if (file == null) {
              UserNote usernote =
                  UserNote(title: title, note: note, imageurl: widget.imageurl);
              ...
              Reference editedusermedia = FirebaseStorage.instance
                  .ref(FirebaseAuth.instance.currentUser!.uid)
                  .child("$gallerypath");

              await editedusermedia.putFile(file!);

              imageurl = await editedusermedia.getDownloadURL();

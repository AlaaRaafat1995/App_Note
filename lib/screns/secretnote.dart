...
import 'package:app_note/screns/editsecretnote.dart';
...
class SecretNotes extends StatefulWidget {
  SecretNotes({Key? key, this.file}) : super(key: key);
  File? file;
...
class _SecretNotesState extends State<SecretNotes> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        appBar: AppBar(title: Customtext(text: "Secret Notes"), actions: [
          iconbutton(() {
